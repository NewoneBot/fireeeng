            ...
            <div class="abt-sec">
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-12 col-lg-7">
                        <div class="abt-cnt">
                            <div class="sec-tl">
                                <h2 itemprop="headline"><strong>Company Overview</strong></h2>
                            </div><!-- Sec Title -->
                            <div class="abt-desc">
...
To provide <strong>high-quality fire extinguishers</strong> and <strong>comprehensive fire safety solutions</strong> across Mohali and Punjab. We aim to make fire protection <strong>affordable</strong>, <strong>accessible</strong>, and <strong>understandable</strong> for every home, office, and industry. Our mission is to create <strong>fire-safe environments</strong> through reliable products and expert guidance.
                            ...
                            <div class="abt-desc">
                                <p itemprop="description">
To become the <strong>leading fire extinguisher supplier</strong> and <strong>fire safety service provider</strong> in North India by 2030. We envision a future where <strong>every building is equipped, every person is trained</strong>, and <strong>fire risks are minimized</strong> through proactive protection and awareness.                            </div>
                        </div>
                    </div>
