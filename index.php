...
>
                <div class="featured-cap">
                  ...
                  <div class="btns-grp">
                    <a
                      ...
                      href="product1.php"
                      title="View all fire safety products"
                      >View Products</a
                    >
                    <a
                      class="wht-btn brd-rd30"
                      href="contact.php"
                      title="Contact Fire BeGit for fire safety solutions"
                      >Contact Us</a
                    >
                  </div>
                </div>
  ...
  ">
                <div class="featured-cap">
                  <span
                    ><strong
                      >High-Performance Fire Fighting Equipment</strong
                    ></span
                  >
                  <h2>
                  ...
                  <div class="btns-grp">
                    <a
                      class="theme-btn brd-rd30"
                      href="product1.php"
                      title="Explore our firefighting range"
                      >Explore Now</a
                    >
                    <a
                      class="wht-btn brd-rd30"
                      href="contact.php"
                      title="Request a fire safety consultation"
                      >Get Quote</a
                    >
                  </div>
                </div>
                    ...
                    <div class="evnt-bx">
                      ...
                      <div class="evnt-inf">
                        ...
                        <a
                          class="event-btn"
                          href="event-detail.html"
                          title="Read More about Fire Prevention Event"
                          itemprop="url"
                          >Read More</a
                        >
                      </div>
